...
const RUNOUT=SMOKE ? joinpath(COHORT_OUT,"smoke") : COHORT_OUT
mkpath(RUNOUT)
...
metadata=Dict("cohort"=>COHORT,"paths_per_origin"=>N,"model_sha256"=>(open(sha256,joinpath(OUT,"surface_model.jld2")) |> bytes2hex),
