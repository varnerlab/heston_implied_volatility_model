...
We calculated terminal profit and loss for a short position that received market mid $p_0$ as follows:
...
\input{sections/chronological_methods}
\input{sections/stock_validation_methods}
